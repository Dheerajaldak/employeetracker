...
const LoginPage = () => {
  ...
  const isLocationReady = !!myLocation;

  const handleSubmit = (e) => {
    e.preventDefault();

    if (!isLocationReady) {
      toast.error("Fetching your location. Please wait...");
      return;
    }
    ...
    setTimeout(() => {
      navigate("/home");
    }, 1600); // Give toast time to appear
  };
  ...
  const onError = (error) => {
    ...
    dispatch(setMyLocation(getFakeLocation()));
  };
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{
          backgroundImage: `url("https://cdn.pixabay.com/photo/2021/04/16/12/38/earth-6183491_1280.png")`,
        }}
      ></div>
